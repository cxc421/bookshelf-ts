...
type handleUserResponseArgument = {user: User};

function handleUserResponse({user}: handleUserResponseArgument) {
...
async function client(endpoint: string, data: User): Promise<any> {
  const config = {
    method: 'POST',
